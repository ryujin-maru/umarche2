<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <form id="form" method="get" action="{{route('user.items.index')}}">
                ...
                <div class="flex">
                    <div>
                        {{-- @php dd(\Constant::SORT_ORDER['recommend'])  @endphp --}}
                        <span class="text-sm">表示順</span><br>
                        <select name="sort" id="sort" sort="name mr-4">
...
<script>
    ...
    paginate.addEventListener('change',() => {
        this.form.submit()
    })
</script>
</x-app-layout>
